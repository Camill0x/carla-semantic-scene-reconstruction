...
PROCESS_SPECS: Dict[str, ProcessSpec] = {
    ...
    "openpcdet_prepare_dataset": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.openpcdet.prepare_dataset",
        ],
    ),
    ...
    "benchmark_openpcdet": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.benchmark.benchmark_openpcdet",
        ],
    ),
    "benchmark_lanedet": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.benchmark.benchmark_lanedet",
        ],
    ),
    "benchmark_view_predictions": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.benchmark.view_predictions",
        ],
    ),
    ...
    "stream_aggregator": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.streaming.live_aggregator",
        ],
    ),
    "stream_visualizer": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.streaming.live_visualizer",
        ],
    ),
    "stream_openpcdet": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.streaming.live_openpcdet_inference",
        ],
    ),
    "stream_lanedet": ProcessSpec(
        ...
        command=[
            ...
            "-u",
            "-m",
            "tools.streaming.live_lanedet_inference",
        ],
    ),
}
...
LANEDET_MAIN_FLAGS = [
    FlagSpec(
        ...
        choices=["laneatt-r34-tusimple", "resa-r34-tusimple"],
    ),
