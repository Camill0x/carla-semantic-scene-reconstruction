...
def main() -> None:
    ...
    for frame_dir in frame_dirs:
        ...
        if objects_path and objects_path.exists():
            ...
            num_predicted_objects = len(objects_3d)
        else:
        ...
        if lanes_path and lanes_path.exists():
            ...
            num_predicted_lanes = len(lanes_prediction["lanes_3d"])
        else:
        ...
        log_dataset_status(
            frame,
            num_predicted_objects=num_predicted_objects,
            num_predicted_lanes=num_predicted_lanes,
        )
