...
# Modified from CARLA generate_traffic.py
# Changes:
# - re-enabled collisions for walker actors after spawning
# -----------------------------------
...
def main():
    ...
    try:
        ...
        # 6. re-enable collisions for walker actors
        for i in range(1, len(all_id), 2):
            all_actors[i].set_collisions(True)
